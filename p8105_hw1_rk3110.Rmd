...
*Still need to describe names/important variables.* The data set is `r nrow(penguins)` rows long and `r `ncol(penguins)` columns wide. The mean flipper length of the data set is *can't get this to work yet come back later*
